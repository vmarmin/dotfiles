# Generated by Powerlevel10k configuration wizard on 2020-05-21 at 22:01 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 52496.
# Wizard options: nerdfont-complete + powerline, small icons, unicode, lean_8colors,
# 2 lines, disconnected, no frame, compact, many icons, concise, instant_prompt=off.
